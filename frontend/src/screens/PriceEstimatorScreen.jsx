...
export default function PriceEstimatorScreen({ user }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // ← NEW — get saved token from login
      const token = localStorage.getItem("lappal_token");

      // ← NEW — real API call (no more mock)
      ...
      // ← NEW — read predictedPrice from real response
    ...
    <div className="page" style={{ maxWidth: 760, margin: "0 auto" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
        ...
        <div style={{ background: "#161b22", border: "1px solid #21262d", borderRadius: 14, padding: 24 }}>
          ...
          <div className="form-group">
            ...
            <select className="form-input" value={form.Company}
          ...
          <div className="form-group">
            ...
            <input className="form-input" placeholder="e.g. Legion Y520-15IKBN"
              value={form.Product} onChange={(e) => handleChange("Product", e.target.value)} />
          </div>

          <div className="form-group">
            <label className="form-label">CPU</label>
            <input className="form-input" placeholder="e.g. Intel Core i7 7700HQ 2.8GHz"
              value={form.Cpu} onChange={(e) => handleChange("Cpu", e.target.value)} />
          </div>

          <div className="form-group">
            <label className="form-label">RAM</label>
            <select className="form-input" value={form.Ram}
          ...
          <div className="form-group" style={{ marginBottom: 0 }}>
            ...
            <input className="form-input" placeholder="e.g. Nvidia GeForce GTX 1060"
        ...
        <div style={{ background: "#161b22", border: "1px solid #21262d", borderRadius: 14, padding: 24 }}>
          ...
          {/* Summary */}
          <div style={{ background: "#0d1117", border: "1px solid #21262d", borderRadius: 10, padding: 14, marginTop: 8 }}>
      ...
      {result !== null && !loading && (
        <div style={{
          ...
          <button className="btn btn-ghost" style={{ marginTop: 16, fontSize: 13 }}
